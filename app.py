...
def hello_world():
    ...
    try:
        ...
        try:
            data_json["user_ratings"] = sum/n
        except:
            data_json["user_ratings"] = 5

        return data_json
    except:
        return {"name":"ERROR","location":"ERROR, CA","depression_stats_percent":0.10,"depression_stats":10,"student_to_mh_ratio_percent":0.69,"student_to_mh_ratio":69,"investment_into_mh_percent":0.30,"investment_into_mh":30,"cost_of_living_and_debt_percent":0.40,"cost_of_living_and_debt":40,"suicide_rate_percent":1.0,"suicide_rate":100,"user_ratings":5}